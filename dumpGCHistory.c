...
extern int newNodeC, newIntValueC, newStringValueC, newClosureValueC,
    newEnvValueC, newListValueC, newClosureC, newEnvC, newBuiltinFunC;
...
void dumpGCHistory(FILE *out) {
  fprintf(out,
          ...
          "          ['BuiltinFunc',    %d],"
          "        ]);",
          newIntValueC, newStringValueC, newClosureValueC, newEnvValueC,
  ...
  fprintf(
      ...
      "        };"
      "        chart = new "
      "google.visualization.AreaChart(document.getElementById('values'));"
      "        chart.draw(data, options);"
      "      }"
      "    </script>"
      "  </head>"
